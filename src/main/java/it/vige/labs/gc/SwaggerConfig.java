...
public class SwaggerConfig {
	...
	public SecurityConfiguration securityConfiguration() {
		...
		return SecurityConfigurationBuilder.builder().clientId("votingPapers").realm("vota-domain")
				.appName("swagger-ui").additionalQueryStringParams(additionalQueryStringParams).build();
	}
