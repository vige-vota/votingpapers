...
CMD java -Djavax.net.ssl.trustStore=/workspace/keystore.p12 -Djavax.net.ssl.trustStorePassword=secret -jar /workspace/vota.jar --server.port=8543 --server.ssl.key-store=/workspace/keystore.p12 --server.ssl.key-store-password=secret --server.ssl.trust-store=/workspace/keystore.p12 --server.ssl.trust-store-password=secret --spring.profiles.active=prod && \
	tail -f /dev/null
